...
type FileOptions struct {
	Path       string // log file path (default /app/logs/app-board.log)
...
func GinLogger() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		// Set by the router's requestID() middleware on unwind, before this
		// post-c.Next() section runs — so every access-log line is traceable.
