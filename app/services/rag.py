...
class RAGService:
    ...
    def __init__(
        ...
        try:
            ...
            logger.warning("[RAG] cloud_backend init failed: {}", e)
    ...
    async def _fallback_answer(
        self, question: str, reason: str = "", context: str = ""
    ) -> dict:
        ...
        try:
            ...
            return {
                "answer": f"Sorry, {reason}. Try building more content or rephrasing.",
                "sources": [],
            }
    ...
    async def answer_question(
        ...
        if not context_parts:
            return {
                "answer": "Found videos but no usable text content.",
                "sources": sources,
            }
        ...
        if not context.strip():
            return {
                "answer": "No usable content to answer your question.",
                "sources": sources,
            }
