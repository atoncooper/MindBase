/**
 * 自由白板编辑器（全幅）：Excalidraw 画布 + 应用自己的顶栏。
 *
 ...
 * 相关 appState 子集）→ Ctrl+S 兜底 + 卸载 flush。深浅主题跟随应用档位
 * 实时切换；导出 PNG/SVG 走共享 exports/ 目录。
 */
...
function WhiteboardEditorView({ mapId }: { mapId: string }): React.JSX.Element {
